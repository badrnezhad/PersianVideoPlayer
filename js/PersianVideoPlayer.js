...
function PersianPlayer(id, options) {
    ...
    $("#" + videoId + "_Loading").css({ "width": parseInt(offsetWidth) + (parseInt(padding) * 2) - 4, "height": offsetHeight, "left": offsetX, "top": offsetY, "padding-top": (offsetY / 2) + 16 }).css("border-radius", options.borderRadius);
